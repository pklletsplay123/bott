...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        case '!ban':
            ...
            if (mentionedJidList.length === 0) return await client.reply(from, 'yuuru ganteng banget', id)
        ...
        case '!waifu':
            const wai = ["Anime Cute Girl", "Kawaii Anime Girl", "Anime School Girl", "Anime Girls"]
